...
public class SprutEvaluatorSingle {
    ...
    public SprutEvaluatorSingle(Consumer<String> outputConsumer, String testsDirectory, String analyzerClass,
                                String inputRegex, String outputRegex) {
    ...
    public boolean evaluateAll() throws IOException, InterruptedException {
        ...
        for (Path caseDir : Files.newDirectoryStream(testsDirectory)) {
            ...
            testCounter++;
            boolean result = evaluateTestCase(caseName, input, expected);
    ...
    private boolean evaluateTestCase(String caseName, Path input, Path output)
